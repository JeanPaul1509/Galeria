    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title text-primary" id="my-modal-title"><i class="fas fa-user-plus"></i> Nuevo Cliente</h5>
            ...
            <form method="post" action="<?php echo base_url(); ?>Clientes/insertar" autocomplete="off">
                <div class="modal-body bg-info">
                    <div class="form-group">
                        <strong class="text-dark" for="ruc">Ruc/Dni</strong>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <strong class="text-dark" for="direccion">Dirección</strong>
                                <input id="direccion" class="form-control" type="text" name="direccion" placeholder="Dirección">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <strong class="text-dark" for="telefono">Teléfono</strong>
