...
<div class="page-content bg-light">
    <div class="page-header bg-light">
        <div class="container-fluid">
            <strong class="text-primary"><h2 class="h5 no-margin-bottom">Nueva Compra</h2></strong>
        </div>
    </div>
    <section>
        <div class="container-fluid">
            <form action="" method="post" id="frmCompras" class="row" autocomplete="off">
                <div class="col-lg-3">
                    <div class="form-group">
                        <strong class="text-primary" for="buscar_codigo"><i class="fas fa-barcode"></i> Código de barras</strong>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <strong class="text-primary" for="nombre">Producto</strong>
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        <strong class="text-primary" for="cantidad">Cantidad</strong>
                        <input id="cantidad" class="form-control" type="text" name="cantidad" onkeyup="IngresarCantidad(event);">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <strong class="text-primary" for="precio"><i class="fas fa-ad"></i> Precio</strong>
