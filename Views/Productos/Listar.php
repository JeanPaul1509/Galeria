    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title text-primary" id="my-modal-title"><i class="fas fa-clipboard-list"></i> Nuevo Producto</h5>
            ...
            <form method="post" action="<?php echo base_url(); ?>Productos/insertar" autocomplete="off">
                <div class=" modal-body bg-info">
                    <div class="form-group">
                        <strong class="text-dark" for="codigo">Código</strong>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <strong class="text-dark" for="precio">Precio</strong>
