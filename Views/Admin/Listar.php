...
<div class="page-content bg-light">
    <div class="page-header bg-light">
        <div class="container-fluid">
            <h2 class="text-primary" class="h5 no-margin-bottom">Panel de Administración</h2>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-0 bg-info shadow h-100 py-2">
                        <div class="card-body">
            ...
            <!-- Content Row -->
            <h4 class="text-primary"class="mt-2">Reportes Gráficos</h4>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body bg-light"><canvas id="myBarChart" width="100%" height="50"></canvas></div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body bg-light"><canvas id="myPieChart" width="100%" height="50"></canvas></div>
                    </div>
                </div>
            </div>
        </div>
